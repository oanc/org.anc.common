...
public class UTF16PrintStream extends PrintStream
{
   ...
   public UTF16PrintStream(OutputStream out)
         throws UnsupportedEncodingException
   {
      this(out, true);
   }

   public UTF16PrintStream(String fileName) throws FileNotFoundException,
         UnsupportedEncodingException
   {
      this(new FileOutputStream(fileName), true);
   }

   public UTF16PrintStream(File file) throws FileNotFoundException,
         UnsupportedEncodingException
   {
      this(new FileOutputStream(file), true);
   }

   public UTF16PrintStream(OutputStream out, boolean autoFlush)
         throws UnsupportedEncodingException
   {
